...
public final class ConfigManager {
	...
	private void initEnv() throws FileNotFoundException, IOException {
		...
		try {
			...
			// ========== 手动修改配置文件的前缀(解决前端图片不显示的处理) Begin ========== 
	...
	private String getConfigPath() {
		...
		// ========== 又一个百度的路径坑,修复为rootPath + contextpath 代替parentPath  ==========
		return this.rootPath + File.separator + contextPath + File.separator + ConfigManager.configFileName;
	}
